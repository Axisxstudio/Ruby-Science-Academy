    ...
    <footer className="bg-[linear-gradient(180deg,_#0f4c81,_#0b3558)] py-12 text-white">
      <div className="section-shell grid gap-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr_0.9fr]">
        ...
        <div>
          ...
          <div className="mt-4 space-y-3">
            ...
            >
              <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-red-600/20 border border-red-500/30 group-hover:bg-red-600/30 transition-colors">
              ...
              <span className="leading-snug">YouTube Channel<br /><span className="text-xs text-white/45">@buzzer_AL</span></span>
            </a>
            ...
            <a
              ...
              className="group flex items-center gap-3 text-sm text-white/75 transition hover:text-white"
            >
              <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-green-600/20 border border-green-500/30 group-hover:bg-green-600/30 transition-colors">
              ...
              <span className="leading-snug">WhatsApp Community<br /><span className="text-xs text-white/45">Join our group</span></span>
            </a>
          </div>
        </div>
      </div>
      <div className="section-shell mt-10 flex flex-col gap-4 border-t border-white/10 pt-6 text-[11px] font-bold uppercase tracking-widest text-white/40 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
          <span>© {new Date().getFullYear()} RUBY Science Academy. All rights reserved.</span>
